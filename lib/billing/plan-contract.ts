...
export const billingPlanContract = {
  ...
  business: {
    ...
    public: {
      ...
      ctaLabel: "Choose plan",
      highlights: ["20 users included", "Workspace limits pending Stage 2 decision", "25,000 materials/SKUs", "Onboarding session"],
      limitLabels: {
        users: "20",
        workspaces: "Pending Stage 2 decision",
        teams: "20",
        locations: "Unlimited",
        materials: "25,000",
        suppliers: "2,500",
  ...
  enterprise: {
    ...
    public: {
      ...
      highlights: ["Custom users", "Workspace limits pending Stage 2 decision", "Custom retention", "SLA options"],
      limitLabels: {
        users: "Custom",
        workspaces: "Pending Stage 2 decision",
        teams: "Custom",
