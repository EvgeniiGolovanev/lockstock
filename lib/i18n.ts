...
const FR_TRANSLATIONS: Record<string, string> = {
  ...
  "Pricing | LockStock": "Tarifs | LockStock",
  "Compare LockStock plans for inventory, purchasing, teams, audit logs, and operational limits.":
    "Comparez les offres LockStock pour l'inventaire, les achats, les equipes, les journaux d'audit et les limites operationnelles.",
  "Plans for controlled inventory and purchasing operations":
    "Offres pour piloter les stocks et les achats avec controle",
  "Prices are listed in EUR, excluding VAT. Annual billing gives a lower monthly equivalent while keeping the same operational limits.":
    "Les prix sont indiques en EUR, hors TVA. La facturation annuelle donne un equivalent mensuel plus bas tout en conservant les memes limites operationnelles.",
  "Operations is the recommended plan for most teams because it unlocks unlimited locations, higher daily volume, team workflows, and audit exports.":
    "Operations est l'offre recommandee pour la plupart des equipes, car elle debloque les emplacements illimites, des volumes quotidiens plus eleves, les workflows d'equipe et les exports d'audit.",
  Starter: "Starter",
  Operations: "Operations",
  Business: "Business",
  Enterprise: "Enterprise",
  "For small teams replacing spreadsheets.": "Pour les petites equipes qui remplacent les tableurs.",
  "For teams running daily stock and purchasing workflows.":
    "Pour les equipes qui gerent les stocks et les achats au quotidien.",
  "For multi-site teams that need controls and history.":
    "Pour les equipes multi-sites qui ont besoin de controles et d'historique.",
  "For larger organizations with custom security and support needs.":
    "Pour les grandes organisations avec des besoins personnalises de securite et de support.",
  Recommended: "Recommande",
  "3 users included": "3 utilisateurs inclus",
  "8 users included": "8 utilisateurs inclus",
  "20 users included": "20 utilisateurs inclus",
  "Custom users": "Utilisateurs sur mesure",
  "3 stock locations": "3 emplacements de stock",
  "Unlimited locations": "Emplacements illimites",
  "Custom workspaces": "Espaces de travail sur mesure",
  "Custom retention": "Retention sur mesure",
  "500 materials/SKUs": "500 materiaux/SKU",
  "5,000 materials/SKUs": "5 000 materiaux/SKU",
  "25,000 materials/SKUs": "25 000 materiaux/SKU",
  "50 purchase orders per month": "50 commandes d'achat par mois",
  "3 workspaces": "3 espaces de travail",
  "Onboarding session": "Session d'accompagnement",
  "SLA options": "Options de SLA",
  "Annual contract": "Contrat annuel",
  "EUR 39/mo, billed annually": "EUR 39/mois, facture annuellement",
  "EUR 89/mo, billed annually": "EUR 89/mois, facture annuellement",
  "EUR 179/mo, billed annually": "EUR 179/mois, facture annuellement",
  "/mo excl. VAT": "/mois HT",
  "Start trial": "Demarrer l'essai",
  "Limits by Plan": "Limites par offre",
  "Plan boundaries follow the current LockStock modules: teams, roles, locations, materials, suppliers, stock movements, purchase orders, imports, reports, and audit logs.":
    "Les limites suivent les modules actuels de LockStock : equipes, roles, emplacements, materiaux, fournisseurs, mouvements de stock, commandes d'achat, imports, rapports et journaux d'audit.",
  Limit: "Limite",
  "Monthly price": "Prix mensuel",
  "Annual equivalent": "Equivalent annuel",
  "Included users": "Utilisateurs inclus",
  "Extra users": "Utilisateurs supplementaires",
  "Organizations / workspaces": "Organisations / espaces de travail",
  "Teams / groups": "Equipes / groupes",
  "Materials / SKUs": "Materiaux / SKU",
  "Suppliers / vendors": "Fournisseurs / vendeurs",
  "Purchase orders / month": "Commandes d'achat / mois",
  "Stock movements / month": "Mouvements de stock / mois",
  "CSV material import": "Import CSV de materiaux",
  "Low-stock alerts": "Alertes stock faible",
  "Stock-health report": "Rapport d'etat du stock",
  "Workflow guides": "Guides de workflow",
  "Audit log in app": "Journal d'audit dans l'application",
  "Audit CSV export": "Export CSV d'audit",
  "Data retention": "Retention des donnees",
  Support: "Support",
  Custom: "Sur mesure",
  Unlimited: "Illimite",
  Included: "Inclus",
  "Not included": "Non inclus",
  "Own recent activity": "Activite recente personnelle",
  "Latest 20 organization events": "20 derniers evenements de l'organisation",
  "90 days/export": "90 jours/export",
  "366 days/export": "366 jours/export",
  "12 months": "12 mois",
  "36 months": "36 mois",
  "7 years": "7 ans",
  "EUR 9/user/mo": "EUR 9/utilisateur/mois",
  "EUR 7/user/mo": "EUR 7/utilisateur/mois",
  "100 rows/import": "100 lignes/import",
  "1,000 rows/import": "1 000 lignes/import",
  "10,000 rows/import": "10 000 lignes/import",
  "Priority email": "E-mail prioritaire",
  "Priority + onboarding": "Prioritaire + accompagnement",
  "SLA / dedicated": "SLA / dedie",
  Product: "Produit",
  Company: "Entreprise",
  ...
  Blog: "Blog",
  Contact: "Contact",
  "Contact | LockStock": "Contact | LockStock",
  "Contact LockStock": "Contacter LockStock",
  "Contact the LockStock team about inventory operations, purchasing workflows, and product questions.":
    "Contactez l'equipe LockStock au sujet des operations d'inventaire, des workflows d'achat et des questions produit.",
  "Talk to us about your inventory operations": "Parlez-nous de vos operations d'inventaire",
  ...
  "Message sent. We will reply by email.": "Message envoye. Nous repondrons par email.",
  "Could not send your message.": "Impossible d'envoyer votre message.",
  "Contact email delivery is not configured.": "L'envoi des emails de contact n'est pas configure.",
  "Contact email delivery is temporarily unavailable.": "L'envoi des emails de contact est temporairement indisponible.",
  "Sending...": "Envoi...",
  ...
  "Create material": "Creer un materiau",
  "Move Material": "Deplacer le materiel",
  "PO Number": "Numero BC",
  Lines: "Lignes",
  Progress: "Progression",
  Expected: "Prevu",
  "Expected arrival": "Arrivee prevue",
  "No expected date": "Aucune date prevue",
  Block: "Bloquer",
  Unblock: "Debloquer",
  Blocked: "Bloque",
  ...
  "Purchase Orders Status": "Statut des commandes d'achat",
  ...
  "Add stock to a location, consume it for works, or transfer it between locations.":
    "Ajoutez du stock a un emplacement, consommez-le pour les travaux ou transferez-le entre emplacements.",
  ...
  "Receive order": "Receptionner la commande",
